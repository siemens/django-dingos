...
Menu.add_item( "mantis_main",
               MenuItem("List, Filter & Search", "",
                        weight = 50,
                        children = (
                            MenuItem("Info Object List (generic filter)", reverse("url.dingos.list.infoobject.generic"), ),
                            MenuItem("Info Object List (filter by ID)", reverse("url.dingos.list.infoobject.by_id"), ),
