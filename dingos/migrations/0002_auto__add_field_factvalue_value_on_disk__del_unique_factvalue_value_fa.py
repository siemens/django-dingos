...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Fact.value_on_disk'
        db.delete_column(u'dingos_fact', 'value_on_disk')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Fact.value_on_disk'
        db.add_column(u'dingos_fact', 'value_on_disk',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'dingos.factvalue': {
            'Meta': {'unique_together': "(('value', 'fact_data_type', 'value_on_disk'),)", 'object_name': 'FactValue'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
