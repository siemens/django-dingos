...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'FactValue', fields ['value', 'fact_data_type', 'value_on_disk']
        db.delete_unique(u'dingos_factvalue', ['value', 'fact_data_type_id', 'value_on_disk'])

        # Deleting field 'FactValue.value_on_disk'
        db.delete_column(u'dingos_factvalue', 'value_on_disk')

        # Adding field 'FactValue.storage_location'
        db.add_column(u'dingos_factvalue', 'storage_location',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'FactValue', fields ['value', 'fact_data_type', 'storage_location']
        db.create_unique(u'dingos_factvalue', ['value', 'fact_data_type_id', 'storage_location'])


    def backwards(self, orm):
        # Removing unique constraint on 'FactValue', fields ['value', 'fact_data_type', 'storage_location']
        db.delete_unique(u'dingos_factvalue', ['value', 'fact_data_type_id', 'storage_location'])

        # Adding field 'FactValue.value_on_disk'
        db.add_column(u'dingos_factvalue', 'value_on_disk',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'FactValue.storage_location'
        db.delete_column(u'dingos_factvalue', 'storage_location')

        # Adding unique constraint on 'FactValue', fields ['value', 'fact_data_type', 'value_on_disk']
        db.create_unique(u'dingos_factvalue', ['value', 'fact_data_type_id', 'value_on_disk'])
