...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlobStorage'
        db.create_table(u'dingos_blobstorage', (
        ...
        db.send_create_signal(u'dingos', ['BlobStorage'])


    def backwards(self, orm):
        # Deleting model 'BlobStorage'
        db.delete_table(u'dingos_blobstorage')
