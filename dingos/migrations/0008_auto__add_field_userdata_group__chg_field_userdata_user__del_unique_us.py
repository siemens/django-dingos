...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserData.group'
        db.add_column(u'dingos_userdata', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True),
                      keep_default=False)


        # Changing field 'UserData.user'
        db.alter_column(u'dingos_userdata', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        # Adding unique constraint on 'UserData', fields ['user', 'group', 'data_kind']
        db.create_unique(u'dingos_userdata', ['user_id', 'group_id', 'data_kind'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserData', fields ['user', 'group', 'data_kind']
        db.delete_unique(u'dingos_userdata', ['user_id', 'group_id', 'data_kind'])

        # Deleting field 'UserData.group'
        db.delete_column(u'dingos_userdata', 'group_id')


        # User chose to not deal with backwards NULL issues for 'UserData.user'
        raise RuntimeError("Cannot reverse this migration. 'UserData.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserData.user'
        db.alter_column(u'dingos_userdata', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
