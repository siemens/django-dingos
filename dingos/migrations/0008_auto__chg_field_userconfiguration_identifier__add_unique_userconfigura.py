...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserConfiguration.identifier'
        db.alter_column(u'dingos_userconfiguration', 'identifier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dingos.Identifier'], null=True))
        # Adding unique constraint on 'UserConfiguration', fields ['user']
        db.create_unique(u'dingos_userconfiguration', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserConfiguration', fields ['user']
        db.delete_unique(u'dingos_userconfiguration', ['user_id'])


        # User chose to not deal with backwards NULL issues for 'UserConfiguration.identifier'
        raise RuntimeError("Cannot reverse this migration. 'UserConfiguration.identifier' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserConfiguration.identifier'
        db.alter_column(u'dingos_userconfiguration', 'identifier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dingos.Identifier']))
