...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IO2F2Namespace'
        db.create_table(u'dingos_io2f2namespace', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('io2f', self.gf('django.db.models.fields.related.ForeignKey')(related_name='namespace_thru', to=orm['dingos.InfoObject2Fact'])),
            ('namespace', self.gf('django.db.models.fields.related.ForeignKey')(related_name='io2f_thru', to=orm['dingos.DataTypeNameSpace'])),
            ('position', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'dingos', ['IO2F2Namespace'])


    def backwards(self, orm):
        # Deleting model 'IO2F2Namespace'
        db.delete_table(u'dingos_io2f2namespace')
    ...
    models = {
        ...
        u'dingos.infoobject2fact': {
            ...
            'namespace': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['dingos.DataTypeNameSpace']", 'through': u"orm['dingos.IO2F2Namespace']", 'symmetrical': 'False'}),
        ...
        u'dingos.io2f2namespace': {
            'Meta': {'object_name': 'IO2F2Namespace'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'io2f': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'namespace_thru'", 'to': u"orm['dingos.InfoObject2Fact']"}),
            'namespace': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'io2f_thru'", 'to': u"orm['dingos.DataTypeNameSpace']"}),
