...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IdentifierNameSpaceSubstitutionMap'
        db.create_table(u'dingos_identifiernamespacesubstitutionmap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('importer_namespace', self.gf('django.db.models.fields.related.ForeignKey')(related_name='substituted_namespaces_thru', to=orm['dingos.IdentifierNameSpace'])),
            ('desired_namespace', self.gf('django.db.models.fields.related.ForeignKey')(related_name='importer_namespaces_thru', to=orm['dingos.IdentifierNameSpace'])),
            ('substitution_namespace', self.gf('django.db.models.fields.related.ForeignKey')(related_name='substitution_map', to=orm['dingos.IdentifierNameSpace'])),
        ))
        db.send_create_signal(u'dingos', ['IdentifierNameSpaceSubstitutionMap'])

        # Adding unique constraint on 'IdentifierNameSpaceSubstitutionMap', fields ['importer_namespace', 'desired_namespace', 'substitution_namespace']
        db.create_unique(u'dingos_identifiernamespacesubstitutionmap', ['importer_namespace_id', 'desired_namespace_id', 'substitution_namespace_id'])

        # Adding field 'IdentifierNameSpace.is_substitution'
        db.add_column(u'dingos_identifiernamespace', 'is_substitution',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'IdentifierNameSpaceSubstitutionMap', fields ['importer_namespace', 'desired_namespace', 'substitution_namespace']
        db.delete_unique(u'dingos_identifiernamespacesubstitutionmap', ['importer_namespace_id', 'desired_namespace_id', 'substitution_namespace_id'])

        # Deleting model 'IdentifierNameSpaceSubstitutionMap'
        db.delete_table(u'dingos_identifiernamespacesubstitutionmap')

        # Deleting field 'IdentifierNameSpace.is_substitution'
        db.delete_column(u'dingos_identifiernamespace', 'is_substitution')
    ...
    models = {
        ...
        u'dingos.identifiernamespacesubstitutionmap': {
            'Meta': {'unique_together': "(('importer_namespace', 'desired_namespace', 'substitution_namespace'),)", 'object_name': 'IdentifierNameSpaceSubstitutionMap'},
            'desired_namespace': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'importer_namespaces_thru'", 'to': u"orm['dingos.IdentifierNameSpace']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importer_namespace': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'substituted_namespaces_thru'", 'to': u"orm['dingos.IdentifierNameSpace']"}),
            'substitution_namespace': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'substitution_map'", 'to': u"orm['dingos.IdentifierNameSpace']"})
        },
        u'dingos.infoobject': {
