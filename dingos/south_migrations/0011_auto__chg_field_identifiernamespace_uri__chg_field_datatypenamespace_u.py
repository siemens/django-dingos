...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdentifierNameSpace.uri'
        db.alter_column(u'dingos_identifiernamespace', 'uri', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'DataTypeNameSpace.uri'
        db.alter_column(u'dingos_datatypenamespace', 'uri', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'IdentifierNameSpace.uri'
        db.alter_column(u'dingos_identifiernamespace', 'uri', self.gf('django.db.models.fields.URLField')(max_length=255, unique=True))

        # Changing field 'DataTypeNameSpace.uri'
        db.alter_column(u'dingos_datatypenamespace', 'uri', self.gf('django.db.models.fields.URLField')(max_length=255, unique=True))
