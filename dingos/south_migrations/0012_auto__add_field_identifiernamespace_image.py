...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdentifierNameSpace.image'
        db.add_column(u'dingos_identifiernamespace', 'image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdentifierNameSpace.image'
        db.delete_column(u'dingos_identifiernamespace', 'image')
